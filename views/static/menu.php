...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="./prize.php" class="menu-link" id="dbprize">
                <i class="menu-icon tf-icons fa ti ti-award"></i>
                <div data-i18n="Price">Loại Giải</div>
            </a>
        </li>
        ...
        <li class="menu-item">
            <a href="./result.php" class="menu-link" id="dbresult">
                <i class="menu-icon tf-icons ti ti-123"></i>
        ...
        <li class="menu-item">
            <a href="../index.php" class="menu-link">
                <i class="menu-icon tf-icons ti ti-clover"></i>
...
<script>
    ...
    // Add an event listener to the menu item to trigger content loading
    const prizeLink = document.querySelector('#dbprize');
    prizeLink.addEventListener('click', function(event) {
        event.preventDefault(); // Prevent the default link behavior
        loadContent('prize'); // Load content when the menu item is clicked
    });
</script>